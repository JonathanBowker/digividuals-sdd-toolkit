...
Spec-Driven Development treats the specification as the source of truth. The agent (Claude Code or equivalent) receives structured, high-quality context and builds to it. You act as architect: design, supervise, review, accept or request changes. You do not tell the agent how to do its job.
